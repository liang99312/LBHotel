...
CREATE TABLE `travel`.`kehu` (
  ...
  `sfz` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE `travel`.`lvxing` (
  ...
  `dh` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `sfz` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `ctsj` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `ctxl` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
